...
private fun DrawScope.drawAnimatedLetterPath(
    progress: Float,
    pathString: String,
    svgTranslateX: Float,
    isDarkMode: Boolean
    ...
    val letterPath = createAdaptedGreekPath(pathString, svgTranslateX)
...
fun DrawScope.drawBigAlpha(progress: Float, isDarkMode: Boolean = false) {
    drawAnimatedLetterPath(progress, BIG_ALPHA_PATH, -80.7087f, isDarkMode)
}

fun DrawScope.drawSmallAlpha(progress: Float, isDarkMode: Boolean = false) {
    drawAnimatedLetterPath(progress, SMALL_ALPHA_PATH, -302.37f, isDarkMode)
}

fun DrawScope.drawBigBeta(progress: Float, isDarkMode: Boolean = false) {
    drawAnimatedLetterPath(progress, BIG_BETA_PATH, -507.282f, isDarkMode)
}

fun DrawScope.drawSmallBeta(progress: Float, isDarkMode: Boolean = false) {
    drawAnimatedLetterPath(progress, SMALL_BETA_PATH, -714.952f, isDarkMode)
}