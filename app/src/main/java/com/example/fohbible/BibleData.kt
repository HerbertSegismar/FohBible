...
object BibleData {
    val oldTestamentBooks = listOf(
        ...
        BibleBook("Exodus", 40, Testament.OLD, "Exo", 2),
        BibleBook("Leviticus", 27, Testament.OLD, "Lev", 3),
        BibleBook("Numbers", 36, Testament.OLD, "Num", 4),
        BibleBook("Deuteronomy", 34, Testament.OLD, "Deu", 5),
        BibleBook("Joshua", 24, Testament.OLD, "Josh", 6),
        BibleBook("Judges", 21, Testament.OLD, "Judg", 7),
        BibleBook("Ruth", 4, Testament.OLD, "Ruth", 8),
        BibleBook("1 Samuel", 31, Testament.OLD, "1Sam", 9),
        BibleBook("2 Samuel", 24, Testament.OLD, "2Sam", 10),
        BibleBook("1 Kings", 22, Testament.OLD, "1Kin", 11),
        BibleBook("2 Kings", 25, Testament.OLD, "2Kin", 12),
        BibleBook("1 Chronicles", 29, Testament.OLD, "1Chr", 13),
        BibleBook("2 Chronicles", 36, Testament.OLD, "2Chr", 14),
        ...
        BibleBook("Jonah", 4, Testament.OLD, "Jon", 32),
        BibleBook("Micah", 7, Testament.OLD, "Mic", 33),
        BibleBook("Nahum", 3, Testament.OLD, "Nah", 34),
    ...
    val newTestamentBooks = listOf(
        ...
        BibleBook("1 Corinthians", 16, Testament.NEW, "1Cor", 46),
        BibleBook("2 Corinthians", 13, Testament.NEW, "2Cor", 47),
        ...
        BibleBook("1 Thessalonians", 5, Testament.NEW, "1Thes", 52),
        BibleBook("2 Thessalonians", 3, Testament.NEW, "2Thes", 53),
        ...
        BibleBook("Philemon", 1, Testament.NEW, "Phlm", 57),
        BibleBook("Hebrews", 13, Testament.NEW, "Heb", 58),
        BibleBook("James", 5, Testament.NEW, "James", 59),
        BibleBook("1 Peter", 5, Testament.NEW, "1Pet", 60),
        BibleBook("2 Peter", 3, Testament.NEW, "2Pet", 61),
        BibleBook("1 John", 5, Testament.NEW, "1John", 62),
        BibleBook("2 John", 1, Testament.NEW, "2John", 63),
        BibleBook("3 John", 1, Testament.NEW, "3John", 64),
